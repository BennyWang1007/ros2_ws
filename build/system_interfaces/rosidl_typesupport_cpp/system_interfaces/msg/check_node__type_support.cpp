...
static const _CheckNode_type_support_symbol_names_t _CheckNode_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, system_interfaces, msg, CheckNode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, system_interfaces, msg, CheckNode)),
  }
};
...
{
  return &::system_interfaces::msg::rosidl_typesupport_cpp::CheckNode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, system_interfaces, msg, CheckNode)() {
  return get_message_type_support_handle<system_interfaces::msg::CheckNode>();
}
